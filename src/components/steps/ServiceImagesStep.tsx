...
export default function ServiceImagesStep({ service, onChange }: { service: ServiceDraft; onChange: (patch: Partial<ServiceDraft>) => void }) {
  return (
    <section className="form-card" aria-labelledby="images-title">
      <div className="section-heading"><p className="eyebrow">Etapa 3 de 4</p><h2 id="images-title">Mostre seu trabalho</h2><p>Adicione pelo menos uma imagem real do serviço. Elas serão compactadas antes do envio.</p></div>
